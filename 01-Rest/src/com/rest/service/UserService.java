...
public class UserService {
	...
	/* http://localhost:8080/01-Rest/rest/users */
	@GET
	public Response getAllUsers() {	 
		return Response.status(200).entity("get all user profiles").build();	 
	}

	/* http://localhost:8080/01-Rest/rest/users/bimal */
	@GET
	@Path("/{userid}")
	...
	/* http://localhost:8080/01-Rest/rest/users/deletedusers */
	@GET
	@Path("/deletedusers")
	...
	/* http://localhost:8080/01-Rest/rest/users/deletedusers/12 */
	@GET
	...
	/* http://localhost:8080/01-Rest/rest/users/userid/12345 */
	@GET
	...
	/* http://localhost:8080/01-Rest/rest/users/username/b2 */
	@GET
	...
	/* http://localhost:8080/01-Rest/rest/users/12/messages/34 */
	@GET
	...
	/* http://localhost:8080/01-Rest/rest/users/query1?from=1&to=99&orderBy=name&orderBy=age */
	@GET
	@Path("/query1")
	...
	/* http://localhost:8080/01-Rest/rest/users/query3 */
	@GET
	@Path("/query3")
	...
	/* http://localhost:8080/01-Rest/rest/users/header1 */
	@GET
	@Path("/header1")
	...
	/* http://localhost:8080/01-Rest/rest/users/header2 */
	@GET
	@Path("/header2")
